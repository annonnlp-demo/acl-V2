...
def average_basic_word(dataset_name, text_name='text'):
    ...
    for value in split_name_list:
        ...
        dic[value] = average_basic_word_(train_dataset, test_dataset, dev_dataset, basic_word_list, text_name)
...
def average_basic_word_(train_dataset, test_dataset, dev_dataset, basic_word_list, text_name):
    _number = 0
    _other = 0
